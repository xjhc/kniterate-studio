...
export function ChartWorkspace({ project, onProject, isDarkMode }: { project: ColorworkProjectV1; onProject: (project: ColorworkProjectV1) => void; isDarkMode: boolean }) {
