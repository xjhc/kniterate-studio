...
export function ChartWorkspace({ project, onProject, isDarkMode, compile, knitProvenEntryId, focusedRowId, onFocusedRowId }: { project: ColorworkProjectV1; onProject: (project: ColorworkProjectV1) => void; isDarkMode: boolean; compile: BlanketCompileState; knitProvenEntryId: string | null; focusedRowId: string | null; onFocusedRowId: (rowId: string) => void }) {
