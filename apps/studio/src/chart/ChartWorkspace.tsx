...
export function ChartWorkspace({ project, onProject, isDarkMode, compile, focusedRowId, onFocusedRowId }: { project: ColorworkProjectV1; onProject: (project: ColorworkProjectV1) => void; isDarkMode: boolean; compile: BlanketCompileState; focusedRowId: string | null; onFocusedRowId: (rowId: string) => void }) {
